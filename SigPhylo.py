...
def inference(input):
    ...
    params = {
        ...
        "beta_fixed"        : utilities.beta_read_name(input["beta_fixed_name"])[2],
    ...
    new_dir = params["dir"] + "/K_" + str(params["k_denovo"]) + "_L_" + str(params["lambda"])
    ...
    beta_df = pd.DataFrame(beta_np, index = current_beta.size()[0] * ["Unknown"], 
    ...
    M_r = utilities.MR_write_csv(params, new_dir)
